...
class AdopterTabBar extends StatefulWidget {
  List<TabEntry> tabs ;
  List<Widget> pageViews  ;

  AdopterTabBar(this.tabs, this.pageViews);

  @override
  _AdopterTabBarState createState() => _AdopterTabBarState(this.tabs, this.pageViews);
}

class _AdopterTabBarState extends State<AdopterTabBar>
  ...
  _AdopterTabBarState(this.tabs, this.pageViews);
}