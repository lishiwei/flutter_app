...
class MyCatWidget extends StatefulWidget {
  MyCatWidget({Key key}) : super(key: key);

  @override
  _MyCatWidgetState createState() => _MyCatWidgetState();
}

class _MyCatWidgetState extends State<MyCatWidget> {
  List<Employee> list = [
    Employee.name(
